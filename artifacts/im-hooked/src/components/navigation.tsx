    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
          <a href="#" className="relative z-10" data-testid="link-home">
            <img 
            ...
            <ul className="flex items-center gap-6">
              {navLinks.map((link) => (
                <li key={link.label}>
                  <a 
                    href={link.href} 
                    className="text-white/80 hover:text-white font-medium text-sm uppercase tracking-wider transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        {mobileMenuOpen && (
          ...
          >
            <ul className="flex flex-col items-center gap-8 w-full text-center">
              {navLinks.map((link) => (
                ...
                >
                  <a 
                    ...
                    className="text-white text-3xl font-display font-bold uppercase tracking-wide hover:text-primary transition-colors block"
                  >
                    {link.label}
                  </a>
                </motion.li>
              ...
              >
                <a href="tel:0418769384" className="text-white flex items-center gap-3 text-2xl font-display font-bold">
